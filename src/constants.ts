...
export const API_URLS: { [chainId: number]: string | undefined } = {
  ...
  43: 'https://pangolin.api.subscan.io/api/scan/evm/contract/verifysource',
  44: 'https://crab.api.subscan.io/api/scan/evm/contract/verifysource',
  45: 'https://pangoro.api.subscan.io/api/scan/evm/contract/verifysource',
  46: 'https://darwinia.api.subscan.io/api/scan/evm/contract/verifysource',
...
export const EXPLORER_URLS: { [chainId: number]: string | undefined } = {
  ...
  43: 'https://pangolin.subscan.io/address',
  44: 'https://crab.subscan.io/address',
  45: 'https://pangoro.subscan.io/address',
  46: 'https://darwinia.subscan.io/address',
