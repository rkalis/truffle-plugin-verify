...
module.exports = {
  ...
  networks: {
    ...
    bttc: {
      provider: () => new HDWalletProvider(`${process.env.MNEMONIC}`, `https://rpc.bt.io`),
      network_id: 199,
      confirmations: 2,
    },
    donau: {
      provider: () => new HDWalletProvider(`${process.env.MNEMONIC}`, `https://pre-rpc.bt.io/`),
      network_id: 1029,
      confirmations: 2,
      gasPrice: 300000000000000,
    },
    aurora_mainnet: {
      provider: () => new HDWalletProvider(`${process.env.MNEMONIC}`, `wss://mainnet.aurora.dev`),
      network_id: 1313161554,
      confirmations: 4,
      gasPrice: 0,
    },
    aurora_testnet: {
      provider: () => new HDWalletProvider(`${process.env.MNEMONIC}`, `wss://testnet.aurora.dev`),
